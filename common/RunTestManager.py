...
class RunTestManager(object):
    ...
    def init_tester_data(self, device, which_user):
        try:
            ...
            desired_caps['appPackage'] = 'gaosi.com.learn'
            desired_caps['appActivity'] = '.studentapp.loading.SplashingActivity'
            desired_caps['appWaitActivity'] = '.studentapp.login.LoginActivity'
